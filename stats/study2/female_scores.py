...
above_f = [5, 3, 3, 6, 2, 2, 4, 2]
eye_f = [5, 1, 4, 2, 4, 4, 4, 5]
right_f = [4, 2, 3, 4, 2, 7, 3, 2]
below_f = [6, 2, 6, 6, 7, 7, 7, 4]

#female "socially awkward" score, part 2
# above_f = [3, 3, 2, 7, 1, 6, 2, 2]
# eye_f = [2, 1, 3, 2, 1, 4, 2, 5]
# right_f = [3, 3, 3, 3, 1, 4, 1, 4]
# below_f = [3, 2, 6, 5, 2, 7, 6, 4]
